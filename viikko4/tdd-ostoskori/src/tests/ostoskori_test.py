...
class TestOstoskori(unittest.TestCase):
    ...
    def test_kahden_saman_tuotteen_lisaamisen_jalkeen_korissa_yksi_ostosolio_jonka_nimi_oikein_ja_lukumaara_kaksi(self):
        self.kori.lisaa_tuote(self.maito)
        self.kori.lisaa_tuote(self.maito)
        ostos = self.kori.ostokset()[0]
        self.assertEqual(ostos.tuotteen_nimi(), "Maito")
    ...
    def test_kahden_saman_tuotteen_lisaamisen_ja_toisen_poiston_jalkeen_korissa_yksi_ostosolio_jonka_nimi_oikein_ja_lukumaara_yksi(self):
        self.kori.lisaa_tuote(self.maito)
        self.kori.lisaa_tuote(self.maito)
